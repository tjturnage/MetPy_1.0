...
extent, x_ticks, y_ticks = plot_extent(lons,lats,rda_lon,rda_lat,0.15)
...
plt.suptitlesize : 20
plt.suptitle('{}'.format(str(radar_file.stid[1:])), fontsize=14)
...
for y,a in zip([0,1],axes.ravel()):
    ...
    a.set_title(this_sweep['sweep_type'], fontsize=11)
